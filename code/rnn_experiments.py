...
if __name__ == "__main__":
    ...
    if mode == 'student-predict':
        U = np.load('Q4B_C/rnn.U_h50_s1_r4.0_e25.npy')
        V = np.load('Q4B_C/rnn.V_h50_s1_r4.0_e25.npy')
        W = np.load('Q4B_C/rnn.W_h50_s1_r4.0_e25.npy')
        vocab_size = len(V[0])
        hdim = len(U[0])
    ...
    if mode == 'student-test':
        U = np.load('Q4B_B/rnn.U_h5_s1_r2.0_e25.npy')
        V = np.load('Q4B_B/rnn.V_h5_s1_r2.0_e25.npy')
        W = np.load('Q4B_B/rnn.W_h5_s1_r2.0_e25.npy')
        vocab_size = len(V[0])
        hdim = len(U[0])
